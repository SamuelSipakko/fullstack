...
const App = () => {
    ...
    const handleAdd = () => {
        personService
            ...
            .catch(() => newNotification(`Couldn't add ${newName} to the server`, false) )
    }
    ...
    const handleUpdate = () => {
        ...
        personService
            ...
            .catch(() => {
                setPersons(persons.filter(p => p !== toBeUpdated))
                newNotification(`${newName} doesn't exist on server`, false)
                setNewName('')
                setNewNum('')
            })
    }
